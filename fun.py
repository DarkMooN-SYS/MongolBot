...
class PollView(discord.ui.View):
    def __init__(self, question, options, allow_new_options, max_new_options, admin_id):
...
class fun(commands.Cog):
    ...
    async def poll(self, interaction: discord.Interaction, question: str, option1: str, option2: str, option3: str = None, option4: str = None, option5: str = None, option6: str = None, 	         option7: str = None, option8: str = None, option9: str = None, option10: str = None, allow_new_options: bool = False, max_new_options: int = 0):
